...
neighbor_list = gala.NeighborList(all_info, 1.5, 0.1)
neighbor_list.addExclusionsFromBonds()
lj = gala.LJForce(all_info, neighbor_list, 2**(1.0/6.0)) #( , , rcut)
lj.setParams('B', 'B', 0.1, 1.0, 1.0)
lj.setParams('B', 'C', 0.3, 1.0, 1.0)
lj.setParams('B', 'D', 1.0, 1.0, 1.0)
lj.setParams('C', 'D', 1.0, 1.0, 1.0)
lj.setParams('C', 'C', 0.3, 1.0, 1.0)
lj.setParams('D', 'D', 0.5, 1.0, 1.0)
lj.setParams('A', 'A', 0.5, 1.0, 1.0)
lj.setParams('A', 'B', 1.0, 1.0, 1.0)
lj.setParams('A', 'C', 1.0, 1.0, 1.0)
lj.setParams('A', 'D', 0.5, 1.0, 1.0)
lj.setParams('A', 'S', 0.5, 1.0, 1.0)
lj.setParams('B', 'S', 1.5, 1.0, 1.0)
lj.setParams('C', 'S', 1.0, 1.0, 1.0)
lj.setParams('D', 'S', 0.5, 1.0, 1.0)
lj.setParams('S', 'S', 0.5, 1.0, 1.0)
lj.setEnergy_shift()
app.add(lj)
